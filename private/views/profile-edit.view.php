    ...
    <?php if($row):?>
        ...
        <div class="row" >
            <div class="col-sm-4 col-md-3" >
                <img src="<?=$image?>" class="border  d-block mx-auto" style="width:150px; "  alt="profile_img">
                <br>
            ...
            <div class="col-sm-8 col-md-9 bg-light p-2" >
                <div class="p-4 mx-auto shadow rounded">
                    ...
                    <input class=" my-2 form-control" value ="<?=get_var('firstname', $row->firstname)?>"   type="text" name="firstname" placeholder="First name">
                    <input class=" my-2 form-control" value ="<?=get_var('lastname', $row->lastname)?>" type="text" name="lastname" placeholder="Last name">
                    ...
                    <br>
                    <button class="btn btn-danger float-end"> Save changes </button>
                    
                    <a href="<?=ROOT?>/profile/<?=$row->user_id?>">
                        <button type="button" class="btn btn-success"> Back to profile </button>
                    </a>
